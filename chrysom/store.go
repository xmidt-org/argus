...
type Pusher interface {
	...
	PushItem(owner string, item model.Item,ctx context.Context) (PushResult, error)

	// Remove will remove the matching item from the store and return it.
	RemoveItem(id, owner string,ctx context.Context) (model.Item, error)
}
...
type Reader interface {
	...
	GetItems(owner string,ctx context.Context) (Items, error)
